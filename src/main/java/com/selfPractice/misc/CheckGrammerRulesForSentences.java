...
public class CheckGrammerRulesForSentences {
	...
	public static void main(String[] args) {
		String[] str = { "I love cinema.", "The vertex is S.", "I am single.", "My name is KG.", "I lovE cinema.", "GeeksQuiz. is a quiz site.", "I love Geeksquiz and Geeksforgeeks.", " You are my friend.", "I love cinema" };
		int str_size = str.length;
		int i = 0;
		for (i = 0; i < str_size; i++) {
			char[] carr = str[i].toCharArray();
			if (checkSentence(carr)) {
				System.out.println("is correct: " + str[i]);
			} else {
				System.out.println("is incorrect: " + str[i]);
			}
		}
	}
