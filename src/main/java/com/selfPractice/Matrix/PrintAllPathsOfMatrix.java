...
public class PrintAllPathsOfMatrix {
	 ...
	 * robot (For the first call use 0,0) m, n: Dimensions of given the matrix
	 * pi: Next index to be filed in path array path[0..pi-1]: The path
	 * traversed by robot till now (Array to hold the path need to have space
	 * for at least m+n elements)
	 */
	...
	static void printAllPaths(int[][] mat, int m, int n) {
