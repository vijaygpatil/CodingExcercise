...
public class SumTwoLinkedList {
	...
	private static void simpleTest() {
		...
		S = addTwoNumbers(L, R);
		assert (S.data.equals(0) && S.next.data.equals(0) && S.next.next.data.equals(0) && S.next.next.next.data.equals(1));
	...
	public static void main(String[] args) {
		...
		ListNode<Integer> S = addTwoNumbers(L, R);
		assert (S.data.equals(7) && S.next.data.equals(0) && S.next.next.data.equals(1) && S.next.next.next.data.equals(1));
